...
export const data = new SlashCommandBuilder()
    ...
    .addSubcommand((sub) => sub.setName("attiva").setDescription("Attiva il tracciamento donazioni"))
    .addSubcommand((sub) => sub.setName("disattiva").setDescription("Disattiva il tracciamento donazioni"))
...
//# sourceMappingURL=donazioni.js.map