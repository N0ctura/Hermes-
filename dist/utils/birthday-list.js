...
function buildBirthdayListBody(birthdays) {
...
export function buildBirthdayListEmbed(config) {
    const body = buildBirthdayListBody(config.birthdays);
    return new EmbedBuilder()
        .setColor(LIST_EMBED_COLOR)
        .setTitle("🎂 Lista Compleanni")
        .setDescription("I compleanni vengono festeggiati nel giorno e mese indicati, in base al fuso orario del server.\n\n" +
        body)
 ...
 */
export async function refreshBirthdayListMessage(client, guildId) {
...
//# sourceMappingURL=birthday-list.js.map